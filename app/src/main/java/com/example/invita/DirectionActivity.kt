...
class DirectionActivity : AppCompatActivity(), OnNavigationReadyCallback, NavigationListener {
    ...
    override fun onRestoreInstanceState(savedInstanceState: Bundle) {
        ...
        navigationView!!.onSaveInstanceState(savedInstanceState)
    }
        ...
        if (!isRunning && !::navigationMapboxMap.isInitialized) {
            if (navigationView!!.retrieveNavigationMapboxMap() != null) {
                ...
                /*fusedLocationClient.lastLocation.addOnSuccessListener { location: Location?->
                    ...
                    val dest = Point.fromLngLat(106.878859, -6.372335)
    ...
    private fun getDirectionsRoute(): DirectionsRoute {
        ...
        if (rute == null){
            Log.e("rute","rutenya null")
        }

        else{
            Log.e("rute","rutenya ngga null")
